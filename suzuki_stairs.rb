...
#    He is curious how many stairs might be climbed over the next 20 
...
# You will receive the following data structure representing the
#  stairs Suzuki logged in a year. You will have all data for the entire year so 
...
def stairs_in_20(stairs)
    #your code here
    #for each element (day) we need to add together each element, and add this to the total
    sum = 0
    stairs.each do |days|
        days.each do |entry|
            sum += entry
